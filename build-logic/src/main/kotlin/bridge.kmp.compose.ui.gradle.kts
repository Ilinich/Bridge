/**
 * For a module whose common code *is* Compose — the design system, the navigation host, the
 * gesture. Its counterpart, `bridge.kmp.compose`, is for a module that merely has a Compose side
 * on Android: there the toolkit belongs to androidMain and never reaches the iOS framework.
 */
plugins {
