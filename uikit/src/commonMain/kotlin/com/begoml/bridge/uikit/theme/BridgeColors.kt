 ...
 * accent never has to compete for attention. Win, draw and loss are semantic and separate from
 * the accent, because a result must not read as a call to action.
 */
object BridgeColors {
